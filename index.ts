const form: HTMLElement | null = document.querySelector("form"); //form loop for playername entering and submitting
const firstPage: HTMLElement | null = document.getElementById("firstPage");
const topicChoicesPage: HTMLElement | null =
  document.getElementById("topicChoicePage");
const quizPage: HTMLElement | null = document.getElementById("quizPage");
const choicelinks: any = document.querySelectorAll(".choicelink");
let questionArray: any[];
let currentIndex: number = 0;
let score = 0;
let nextButton: any = document.getElementById("nextButton");
let answerchoice: any = document.querySelectorAll(".choice");
let resultPage: HTMLElement | null = document.getElementById("resultPage");
let username: any = document.getElementById("PlayerNameInput");
let loserText: HTMLElement | null = document.getElementById("loserText");
let winnerText: HTMLElement | null = document.getElementById("winnerText");
let closedGiftbox: HTMLElement | null =
  document.getElementById("closedGiftbox");
let loserGift1: HTMLElement | null = document.getElementById("loserGift1");
let ultimateGift: HTMLElement | null = document.getElementById("ultimateGift");
...
function handleSubmit(e: any) {
  ...
  username = (document.getElementById("PlayerNameInput") as HTMLInputElement)
  ...
  let music: any = document.getElementById("mainMusic");
  music.play();
}

function chooseTopic(e: any) {
  console.log(score);
...
function fetchQuestions(category: string) {
...
function DisplayQuestion() {
  ...
  let h2Question: any = document.getElementById("displayQuestion"); //display the question in our h2 tag in html under quiz page
...
function handleUserChoice(e: any) {
  ...
  if (userChoice === questionArray[currentIndex].correctAnswer.trim()) {
    ...
    let winmusic: any = document.getElementById("winMusic"); //define a var equal to the correct answer audio
    ...
    let losemusic: any = document.getElementById("loseMusic"); //define a var equal to the incorrect answer audio
...
function nextQuestion() {
  if (currentIndex <= 8) {
    ...
    let displayScore: any = document.getElementById("displayScore"); //set a new variable to display score
    ...
    let UserNamesentence: any = document.getElementById("UserNamesentence"); //create variable to equal the span id we created in html
